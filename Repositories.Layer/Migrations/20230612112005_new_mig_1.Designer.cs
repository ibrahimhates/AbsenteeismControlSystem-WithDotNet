...
namespace Repositories.Layer.Migrations
{
    ...
    [Migration("20230612112005_new_mig_1")]
    partial class new_mig_1
    {
            ...
            modelBuilder.Entity("Entities.Layer.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5687),
                            UserId = 1,
                            isActive = true,
                            isDeleted = false
                        },
                        new
                        {
                            Id = 2,
                            CourseName = "Turkce",
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5689),
                            UserId = 1,
                            isActive = true,
                            isDeleted = false
                        });
            ...
            modelBuilder.Entity("Entities.Layer.Models.CourseCalendar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DayId = (byte)1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5404),
                        ...
                        new
                        {
                            DayId = (byte)2,
                            CourseId = 2,
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5415),
                        ...
                        new
                        {
                            DayId = (byte)3,
                            CourseId = 2,
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5416),
                            EndTime = new TimeSpan(0, 12, 0, 0, 0),
            ...
            modelBuilder.Entity("Entities.Layer.Models.CourseDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CourseId = 1,
                            AbsenceLimit = (byte)4,
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5599),
                            CurrentAbsence = (byte)0,
                            Description = "My favorite course 1",
                            ExamTime = new DateTime(2023, 6, 19, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5576),
                            isActive = true,
                            isDeleted = false
                        },
                        new
                        {
                            CourseId = 2,
                            AbsenceLimit = (byte)4,
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5601),
            ...
            modelBuilder.Entity("Entities.Layer.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "79bd127d-d2b3-4f9a-940e-11b938654bcb",
                            CreatedDate = new DateTime(2023, 6, 12, 14, 20, 4, 718, DateTimeKind.Local).AddTicks(5967),
                            Email = "admin1@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin1@GMAIL.COM",
                            NormalizedUserName = "ADMİN1",
                            PasswordHash = "AQAAAAEAACcQAAAAEP3a62kUC53aKEOzWzGL+mkqVSuv2hzedkY3U1nMFxbolwY2LTpjO4nXwEp1P2LVfw==",
                            PhoneNumber = "+9053399999991",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "8051f6f8-ac3f-4558-ae05-fbe4d5282250",
